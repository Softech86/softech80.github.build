...
<svg version="1.1" id="图层_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="-540 253.8 298.9 298.9" style="enable-background:new -540 253.8 298.9 298.9;" xml:space="preserve" :width="width" :height="height">
<rect x="-515.5" y="278.3" transform="matrix(0.9755 0.2202 -0.2202 0.9755 79.2176 95.8808)" class="st0" width="250" height="250"/>
